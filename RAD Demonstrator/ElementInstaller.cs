namespace Elements
{
	...
	internal class ElementInstaller
	{
		...
		public void InstallDefaultContent()
		{
			...
			CreateElement($"RAD - Commtia LON 1", "Empower 2025 - AI - Commtia DAB", "1.0.0.1-fast", LondonViewID, "TrendTemplate_PA_Demo", "AlarmTemplate_PA_Demo");
			CreateElement($"RAD - Commtia LON 2", "Empower 2025 - AI - Commtia DAB", "1.0.0.1-fast", LondonViewID, "TrendTemplate_PA_Demo", "AlarmTemplate_PA_Demo");
			CreateElement($"RAD - Commtia LON 3", "Empower 2025 - AI - Commtia DAB", "1.0.0.1-fast", LondonViewID, "TrendTemplate_PA_Demo", "AlarmTemplate_PA_Demo");
			CreateElement($"RAD - Commtia STH 1", "Empower 2025 - AI - Commtia DAB", "1.0.0.1-fast", SouthamptonViewID, "TrendTemplate_PA_Demo", "AlarmTemplate_PA_Demo");
		}
